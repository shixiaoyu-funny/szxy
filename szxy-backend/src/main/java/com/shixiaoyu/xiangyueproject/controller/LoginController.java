...
import com.shixiaoyu.xiangyueproject.utils.ClientUtil;
...
public class LoginController {
    ...
    public Result<String> sendCode(
            @Parameter(description = "手机号/邮箱", required = true)
            @NotBlank(message = "手机号/邮箱不能为空") @RequestParam String content,
            HttpServletRequest request) {
        return Result.ok(loginService.sendCode(content, ClientUtil.getClientIp(request)));
    }
